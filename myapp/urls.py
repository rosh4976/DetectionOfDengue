...
urlpatterns = [
    ...
    path('dataset_get/', views.dataset_get),
    path('dataset_post/', views.dataset_post),
    path('LRpred_get/', views.LRpred_get),
    path('LRpred_post/', views.LRpred_post),
    path('SVMpred_get/', views.SVMpred_get),
    path('SVMpred_post/', views.SVMpred_post),
    path('DTpred_get/', views.DTpred_get),
    path('DTpred_post/', views.DTpred_post),
    path('XGpred_get/', views.XGpred_get),
    path('XGpred_post/', views.XGpred_post),
]
